...
class cix_ldap::params {
  ...
  $client_config_template  = "${module_name}/ldap.conf.erb"
  ...
  $server_config_template     = "${module_name}/slapd.conf.erb"
  ...
  $server_schema_source_directory = "puppet://${server}/modules/${module_name}"
